...
public class AdminController {
	...
	public String deleteMembers(@ModelAttribute DeleteMembersDTO deleteMembersDTO, Model model) throws Exception {		
...
//		List<CategoryVO> homeMapper.selectCategoryVOs();
	...
	public String memberAdd(@ModelAttribute AddMemberDTO addMemberDTO, Model model) throws Exception {
		...
		adminMapper.insertMember(username, password, email, phone, address);
