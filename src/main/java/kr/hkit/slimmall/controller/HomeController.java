...
public class HomeController {
	...
	public String main(@ModelAttribute HomeDTO homeDTO,Model model) throws Exception {
		int categoryIdx = 0;
		String keyword = homeDTO.getKeyword();
	...
	public String productList(@ModelAttribute ProductListDTO productListDTO, Model model) throws Exception {
		int categoryIdx = productListDTO.getCategoryIdx();
		String keyword = productListDTO.getKeyword();
